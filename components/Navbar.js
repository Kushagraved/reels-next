...
import insta from '../pages/signup/assets/insta.png'
...
const ResponsiveAppBar = () => {
  ...
  //in nextjs useHistory ka replacement
  ...
  const handleLogout = async() => {
    ...
    // Programmatic Redirect(history.push())
    router.push('/login')
  }
  ...
  return (
    <AppBar position="static" className="navbar" style={{background:'#FFFFFF'}}>
